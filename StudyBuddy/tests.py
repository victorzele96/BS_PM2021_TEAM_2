...
class DeleteTeacherTest(TestCase):
    ...
    def test_delete_teacher_details(self):
...
class ViewTeacherDetailsTest(TestCase):
    ...
    def test_view_teacher_details(self, username='teacher', password='teacher', email='teacher@teach.er', first_name='tea', last_name='cher'):
...
class ViewStudentDetailsTest(TestCase):
    ...
    def test_view_student_details(self, username='student', password='student', email='student@stude.nt', first_name='stud', last_name='ent'):
